...
public class TestTeleMedServant {
  ...
  public void shouldStoreInXDS() {
    ...
    assertThat(meta.getPersonID(), is(HelperMethods.NANCY_CPR));
  }
  ...
  public void shouldHandleBasicTeleStoreAPI() {
    ...
    assertThat(calculated1.getSystolic().toString(), is("Systolisk BT:123.0 mm(Hg)"));
  ...
  public static void verifyQueries(TeleMed telemed, XDSBackend thexds) {
    ...
    // Validate entry 1 
    doc = array[0];
    assertEquals("pid001", XMLUtility.getValueOfAttrNamedInNodeIndexNamedEnclosedInNodeInDoc("extension", 0, "id", "patient", doc));
    ...
    doc = array[1];
    assertEquals("pid001", XMLUtility.getValueOfAttrNamedInNodeIndexNamedEnclosedInNodeInDoc("extension", 0, "id", "patient", doc));
    assertEquals("20120601103000", XMLUtility.getValueOfAttrNamedInNodeIndexNamedEnclosedInNodeInDoc("value", 0, "effectiveTime", "ClinicalDocument", doc));
    ...
    // Validate entry
    doc = array[0];
    assertEquals("pid002", XMLUtility.getValueOfAttrNamedInNodeIndexNamedEnclosedInNodeInDoc("extension", 0, "id", "patient", doc));
    // The HL7 format is YYYYMMDDHHMMSS for time stamps
    assertEquals("20120601083000", XMLUtility.getValueOfAttrNamedInNodeIndexNamedEnclosedInNodeInDoc("value", 0, "effectiveTime", "ClinicalDocument", doc));
  }
