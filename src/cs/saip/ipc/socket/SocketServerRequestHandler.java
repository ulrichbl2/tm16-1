...
/**
 * Implementation of the Server Request Handler using simple sockets for IPC. It
 * is a Runnable and the main method of the server must create a thread that has
 * an instance to support receiving network requests.
 * <p>
 * The current implementation is pretty verbose for learning purposes.
 * 
 * @author Henrik Baerbak Christensen, Aarhus University
 *
 */
public class SocketServerRequestHandler implements Runnable, ServerRequestHandler {
  ...
  public void run() {
    ...
    while (!isStopped) {
      ...
      try {
        ...
        System.out.println("ERROR: IOException encountered: "+e.getMessage());
      }
    }
    System.out.println("Server Stopped.");
  }
